...
public final class SingleDeploymentTest {
     ...
     public static WebArchive createDeployment () {
          return DeploymentTestUtil.createDeployment(SingleDeploymentTest.DEPLOYMENT_NAME);
     }

     @Test
     public void testDeploymentURL () throws Exception {
          DeploymentTestUtil.verifyDeployment(SingleDeploymentTest.DEPLOYMENT_NAME, this.verificationBean, this.url);
     }

     @Test
     public void testDeploymentURLAsParameter (@InContainerResource final URL url) throws Exception {
          DeploymentTestUtil.verifyDeployment(SingleDeploymentTest.DEPLOYMENT_NAME, this.verificationBean, url);
     }
